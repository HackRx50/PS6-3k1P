...
async def gen_script_and_choose_vid(pdf_content, n):
    ...
    description_dict = {
        "Car": "vid1: a man carefully takes care of his posh car by cleaning the window sill with his hands. vid2: BMW car driving down the road. vid3: a car accident with a truck in the highway. vid4: a happy family enjoying in their car.",
        "Health": "vid1: doctor treating a little girl, with mother by her side. vid2: people attending a funeral. vid3: cute baby playing with cake frosting in a lively family party. vid4: grandparents happily playing with grand children. vid5: surgeons treating a patient on an operation table. vid6: doctor discussing with family with patient in bed. vid7: analysing tax returns",
        "Daily Needs": "vid1: a man is filling out bills. vid2: young boy gets injured and falls off the cycle, mother tends to him with a bandaid. vid3: a happy couple shops for groceries. vid4: working out in gym. vid5: heavy rains drowns a car.",
        "Others": "vid1: a man carefully takes care of his posh car by cleaning the window sill with his hands. vid2: BMW car driving down the road. vid3: a car accident with a truck in the highway. vid4: a happy family enjoying in their car. vid5: doctor treating a little girl, with mother by her side. vid6: people attending a funeral. vid7: cute baby playing with cake frosting in a lively family party. vid8: grandparents happily playing with grand children. vid9: surgeons treating a patient on an operation table. vid10: doctor discussing with family with patient in bed. vid11: analysing tax returns. vid12: a man is filling out bills. vid13: young boy gets injured and falls off the cycle, mother tends to him with a bandaid. vid14: a happy couple shops for groceries. vid15: working out in gym. vid16: heavy rains drowns a car."
    }
    ...
    n= n/10
    prompt = '''Content:''' + pdf_content + "\n\n" + f'''Think of yourself as an expert script writter for compeling social media videos. From the content, make scripts for a video with a storyline and for each script, choose the most suitable videos for from descriptions. The description of the videos are as following. {chosen_description}.The scripts must include all the important information in content for any customer. Each script should 1)not use vid description as is to write the script, just use it to choose 2)be less than 25 words 3) have a total of ONLY{n} scripts. The narrative should mention the product as solution for the problem. Use simpler language, make it sound more natural like someone is narrating a story. Can change up order of video and script pairs to make better sense, no repetition of video. The answer should contain the subscript to be spoken and corresponding chosen vid. Format the answer ONLY as a list of json objects with 2 key called Subscript and Video(containes name of chosen video). Only give the json.'''
    ans = await chat_completion(prompt)
    ans = ans.strip("```")
